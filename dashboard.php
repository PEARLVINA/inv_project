			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Username Name Here</p>
						...
						<div class="col-sm-12">
							<div class="card">
						      <div class="card-body">
						        ...
						        <p class="card-text">Here you can make invoices and create new request</p>
						        <a href="new_order.php" class="btn btn-primary">New Requests</a>
						      </div>
						    </div>
						</div>
					</div>
