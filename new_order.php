	...
	<div class="container">
				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return false">
				  		<div class="form-group row">
				  			<label class="col-sm-3 col-form-label" align="right">Requests Date</label>
				  			<div class="col-sm-6">
				  				<input type="text" id="order_date" name="order_date" readonly class="form-control form-control-sm" value="<?php echo date("Y-d-m"); ?>">
				  			</div>
				  		</div>
				  		<div class="form-group row">
				  			<label class="col-sm-3 col-form-label" align="right">Admin Id</label>
				  			<div class="col-sm-6">
				  				<input type="text" id="admin_id" name="admin_id" readonly class="form-control form-control-sm" placeholder="Enter Customer Name" value="<?php echo $_SESSION["userid"] ?>"/>
				  			</div>
				  		</div>
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <center>
                      <input type="submit" id="order_form" style="width:150px;" class="btn btn-info" value="Request">
